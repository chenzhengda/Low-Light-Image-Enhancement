...
parser.add_argument('--src_dir', default='datasets/LOL_v1/our485', type=str, help='Directory for full resolution images')    # For LOL-V1
parser.add_argument('--tar_dir', default='datasets/LOL_v1/LOL_v1/our485_patch',type=str, help='Directory for image patches')
