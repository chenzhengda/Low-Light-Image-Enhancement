...
from utils import PSNR, validation, visualization

parser = argparse.ArgumentParser()
parser.add_argument('--gpu_id', type=str, default=0)
parser.add_argument('--img_path', type=str, default='datasets/LOL_v1/our485_patch/low/')
parser.add_argument('--img_val_path', type=str, default='datasets/LOL_v1/eval15_patch/low/')
